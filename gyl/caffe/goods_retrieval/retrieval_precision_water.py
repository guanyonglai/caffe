...
for i in range(1,query_num+1):
    ...
    name3 = name2 + str(i)
    name3 = name3[-4:]
    queryImg = caffe.io.load_image('/mnt/disk1/gyl/image_test/product_retrieval/groundtruth_roi0308/nongfushanquan/'+name3+'.jpg')
    ...
    for k in range(89,98): #groundtruth的序号
        if rank_ID[0]+1==k:
