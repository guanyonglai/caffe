...
name_txt=open('/mnt/disk1/gyl/image_test/shajizhi0502/txt_db/frame_name1354.txt','r')
names=name_txt.readlines()

a = np.loadtxt('/mnt/disk1/gyl/caffe/feats/video_feat0502.xml')
feats = a.reshape(len(names),1024)

query_name='lib13'
for i in range(0,1):
    queryImg = caffe.io.load_image('/mnt/disk1/gyl/image_test/video_retrieval0426/image_db/'+query_name+'.png')
