...
query_file='shajizhi_test'

name_txt=open('/mnt/disk1/gyl/image_test/video_retrieval0426/query/shajizhi_test.txt','r')
names=name_txt.readlines()

name_ku_txt=open('/mnt/disk1/gyl/image_test/shajizhi0502/txt_db/frame_name1354.txt','r')
names_ku=name_ku_txt.readlines()

a = np.loadtxt('/mnt/disk1/gyl/caffe/feats/video_feat0502.xml')
feats = a.reshape(len(names_ku),1024)
...
for i in range(0,len(names)):
    ...
    queryImg = caffe.io.load_image('/mnt/disk1/gyl/image_test/video_retrieval0426/query/'+query_file+'/'+query_name+'.png')
